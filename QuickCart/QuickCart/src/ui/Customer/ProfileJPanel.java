...
public class ProfileJPanel extends javax.swing.JPanel {
    ...
    public ProfileJPanel(EcoSystem ecosystem, CustomerAccount ca, Network network) {
        initComponents();
        this.system = ecosystem;
        this.account = ca;
        this.net = network;
        jTextField1.setText(account.getCustomer().getName());
        jTextField2.setText(account.getCustomer().getEmail());
